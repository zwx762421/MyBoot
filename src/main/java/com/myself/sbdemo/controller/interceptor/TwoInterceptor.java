...
public class TwoInterceptor  implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        if (true) {
            returnErrorResponse(httpServletResponse, MyselfJSONResult.errorMsg("被two拦截..."));
        }
    ...
    public void returnErrorResponse(HttpServletResponse response, MyselfJSONResult result) throws IOException, UnsupportedEncodingException {
